...
// 24 Tabards
uint32 tabardAlly[] = { 60020,	//Tabard of Stormwind
...
{
public: etmaxx_npc() : CreatureScript("etmaxx_npc") {}
...
{
public: etmaxx_battlepass() : CreatureScript("etmaxx_battlepass") {}
...
{
public: etmaxx_transmog_vendor() : CreatureScript("etmaxx_transmog_vendor") {}
...
{
public: etmaxx_start() : CreatureScript("etmaxx_start") {}
...
{
public: etmaxx_tabard() : CreatureScript("etmaxx_tabard") {}
...
{
public: etmaxx_event() : CreatureScript("etmaxx_event") {}
...
{
public: etmaxx_startset() : CreatureScript("etmaxx_startset") {}
...
{
public: etmaxx_keystone() : CreatureScript("etmaxx_keystone") {}
...
{
public: etmaxx_dk() : CreatureScript("etmaxx_dk") {}
...
public: etmaxx_tl() : CreatureScript("etmaxx_tl") {}
      ...
      bool OnGossipHello(Player* player, Creature* creature)
      {
          ...
          AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/Icons/trade_tailoring:30:30:-18:0|tRecipes 2", 2, 0);
          AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/Icons/inv_scroll_03:30:30:-18:0|tRecipes 1", 3, 0);
          AddGossipItemFor(player, GOSSIP_ICON_MONEY_BAG, "|TInterface/Icons/inv_scroll_03:30:30:-18:0|tRecipes 2", 4, 0);
          player->SEND_GOSSIP_MENU(DEFAULT_GOSSIP_MESSAGE, creature->GetGUID());
          return true;

...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] =
{
    ...
    /*0x050*/ { "CMSG_NAME_QUERY",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleNameQueryOpcode                    },
    ...
    /*0x056*/ { "CMSG_ITEM_QUERY_SINGLE",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleItemQuerySingleOpcode              },
    ...
    /*0x05C*/ { "CMSG_QUEST_QUERY",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestQueryOpcode                   },
    /*0x05D*/ { "SMSG_QUEST_QUERY_RESPONSE",                               STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x05E*/ { "CMSG_GAMEOBJECT_QUERY",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleGameObjectQueryOpcode              },
    /*0x05F*/ { "SMSG_GAMEOBJECT_QUERY_RESPONSE",                          STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x060*/ { "CMSG_CREATURE_QUERY",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCreatureQueryOpcode                },
    /*0x061*/ { "SMSG_CREATURE_QUERY_RESPONSE",                            STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x062*/ { "CMSG_WHO",                                                STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleWhoOpcode                          },
    ...
    /*0x066*/ { "CMSG_CONTACT_LIST",                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleContactListOpcode                  },
    ...
    /*0x0AB*/ { "CMSG_USE_ITEM",                                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleUseItemOpcode                      },
    /*0x0AC*/ { "CMSG_OPEN_ITEM",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleOpenItemOpcode                     },
    /*0x0AD*/ { "CMSG_READ_ITEM",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleReadItem                           },
    ...
    /*0x0B1*/ { "CMSG_GAMEOBJ_USE",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleGameObjectUseOpcode                },
    ...
    /*0x0B4*/ { "CMSG_AREATRIGGER",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAreaTriggerOpcode                  },
    ...
    /*0x102*/ { "CMSG_EMOTE",                                              STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleEmoteOpcode                        },
    /*0x103*/ { "SMSG_EMOTE",                                              STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x104*/ { "CMSG_TEXT_EMOTE",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleTextEmoteOpcode                    },
    ...
    /*0x108*/ { "CMSG_AUTOSTORE_LOOT_ITEM",                                STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAutostoreLootItemOpcode            },
    /*0x109*/ { "CMSG_STORE_LOOT_IN_SLOT",                                 STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_NULL                              },
    /*0x10A*/ { "CMSG_AUTOEQUIP_ITEM",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAutoEquipItemOpcode                },
    /*0x10B*/ { "CMSG_AUTOSTORE_BAG_ITEM",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAutoStoreBagItemOpcode             },
    /*0x10C*/ { "CMSG_SWAP_ITEM",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSwapItem                           },
    /*0x10D*/ { "CMSG_SWAP_INV_ITEM",                                      STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSwapInvItemOpcode                  },
    /*0x10E*/ { "CMSG_SPLIT_ITEM",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSplitItemOpcode                    },
    /*0x10F*/ { "CMSG_AUTOEQUIP_ITEM_SLOT",                                STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAutoEquipItemSlotOpcode            },
    /*0x110*/ { "CMSG_UNCLAIM_LICENSE",                                    STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_NULL                              },
    /*0x111*/ { "CMSG_DESTROYITEM",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleDestroyItemOpcode                  },
    ...
    /*0x114*/ { "CMSG_INSPECT",                                            STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleInspectOpcode                      },
    ...
    /*0x11C*/ { "CMSG_CANCEL_TRADE",                                       STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleCancelTradeOpcode                  },
    ...
    /*0x136*/ { "CMSG_CANCEL_AURA",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCancelAuraOpcode                   },
    ...
    /*0x13B*/ { "CMSG_CANCEL_CHANNELLING",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCancelChanneling                   },
    /*0x13C*/ { "SMSG_AI_REACTION",                                        STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x13D*/ { "CMSG_SET_SELECTION",                                      STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSetSelectionOpcode                 },
    ...
    /*0x141*/ { "CMSG_ATTACKSWING",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAttackSwingOpcode                  },
    /*0x142*/ { "CMSG_ATTACKSTOP",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAttackStopOpcode                   },
    ...
    /*0x15A*/ { "CMSG_REPOP_REQUEST",                                      STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleRepopRequestOpcode                 },
    /*0x15B*/ { "SMSG_RESURRECT_REQUEST",                                  STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x15C*/ { "CMSG_RESURRECT_RESPONSE",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleResurrectResponseOpcode            },
    ...
    /*0x17B*/ { "CMSG_GOSSIP_HELLO",                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleGossipHelloOpcode                  },
    ...
    /*0x17F*/ { "CMSG_NPC_TEXT_QUERY",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleNpcTextQueryOpcode                 },
    ...
    /*0x182*/ { "CMSG_QUESTGIVER_STATUS_QUERY",                            STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverStatusQueryOpcode        },
    /*0x183*/ { "SMSG_QUESTGIVER_STATUS",                                  STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x184*/ { "CMSG_QUESTGIVER_HELLO",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverHelloOpcode              },
    /*0x185*/ { "SMSG_QUESTGIVER_QUEST_LIST",                              STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x186*/ { "CMSG_QUESTGIVER_QUERY_QUEST",                             STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverQueryQuestOpcode         },
    /*0x187*/ { "CMSG_QUESTGIVER_QUEST_AUTOLAUNCH",                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverQuestAutoLaunch          },
    /*0x188*/ { "SMSG_QUESTGIVER_QUEST_DETAILS",                           STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x189*/ { "CMSG_QUESTGIVER_ACCEPT_QUEST",                            STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverAcceptQuestOpcode        },
    /*0x18A*/ { "CMSG_QUESTGIVER_COMPLETE_QUEST",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverCompleteQuest            },
    /*0x18B*/ { "SMSG_QUESTGIVER_REQUEST_ITEMS",                           STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x18C*/ { "CMSG_QUESTGIVER_REQUEST_REWARD",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverRequestRewardOpcode      },
    /*0x18D*/ { "SMSG_QUESTGIVER_OFFER_REWARD",                            STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x18E*/ { "CMSG_QUESTGIVER_CHOOSE_REWARD",                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverChooseRewardOpcode       },
    /*0x18F*/ { "SMSG_QUESTGIVER_QUEST_INVALID",                           STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x190*/ { "CMSG_QUESTGIVER_CANCEL",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestgiverCancel                   },
    ...
    /*0x193*/ { "CMSG_QUESTLOG_SWAP_QUEST",                                STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestLogSwapQuest                  },
    /*0x194*/ { "CMSG_QUESTLOG_REMOVE_QUEST",                              STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestLogRemoveQuest                },
    ...
    /*0x19E*/ { "CMSG_LIST_INVENTORY",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleListInventoryOpcode                },
    /*0x19F*/ { "SMSG_LIST_INVENTORY",                                     STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x1A0*/ { "CMSG_SELL_ITEM",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSellItemOpcode                     },
    /*0x1A1*/ { "SMSG_SELL_ITEM",                                          STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x1A2*/ { "CMSG_BUY_ITEM",                                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleBuyItemOpcode                      },
    /*0x1A3*/ { "CMSG_BUY_ITEM_IN_SLOT",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleBuyItemInSlotOpcode                },
    ...
    /*0x1E0*/ { "CMSG_SETSHEATHED",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSetSheathedOpcode                  },
    ...
    /*0x1E3*/ { "CMSG_QUEST_POI_QUERY",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQuestPOIQuery                      },
    ...
    /*0x1F0*/ { "CMSG_PET_CAST_SPELL",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetCastSpellOpcode                 },
    /*0x1F1*/ { "MSG_SAVE_GUILD_EMBLEM",                                   STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleSaveGuildEmblemOpcode              },
    /*0x1F2*/ { "MSG_TABARDVENDOR_ACTIVATE",                               STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleTabardVendorActivateOpcode         },
    ...
    /*0x1FB*/ { "MSG_RANDOM_ROLL",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleRandomRollOpcode                   },
    ...
    /*0x202*/ { "CMSG_UNLEARN_SKILL",                                      STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleUnlearnSkillOpcode                 },
    ...
    /*0x21C*/ { "CMSG_SPIRIT_HEALER_ACTIVATE",                             STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleSpiritHealerActivateOpcode         }, // pussywizard: corpse on other map, GetAreaFlag, this involved vmaps, grids and more
    /*0x21D*/ { "G_SET_STAT_CHEAT",                                        STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_NULL                              },
    ...
    /*0x243*/ { "CMSG_ITEM_TEXT_QUERY",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleItemTextQuery                      },
    ...
    /*0x251*/ { "CMSG_LEARN_TALENT",                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleLearnTalentOpcode                  },
    ...
    /*0x258*/ { "CMSG_AUCTION_LIST_ITEMS",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAuctionListItems                   },
    /*0x259*/ { "CMSG_AUCTION_LIST_OWNER_ITEMS",                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAuctionListOwnerItems              },
    ...
    /*0x264*/ { "CMSG_AUCTION_LIST_BIDDER_ITEMS",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleAuctionListBidderItems             },
    ...
    /*0x268*/ { "CMSG_SET_AMMO",                                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSetAmmoOpcode                      },
    ...
    /*0x26B*/ { "CMSG_PET_CANCEL_AURA",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetCancelAuraOpcode                },
    /*0x26C*/ { "CMSG_PLAYER_AI_CHEAT",                                    STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_NULL                              },
    /*0x26D*/ { "CMSG_CANCEL_AUTO_REPEAT_SPELL",                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCancelAutoRepeatSpellOpcode        },
    ...
    /*0x27A*/ { "CMSG_FAR_SIGHT",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleFarSightOpcode                     },
    ...
    /*0x290*/ { "CMSG_BUYBACK_ITEM",                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleBuybackItem                        },
    ...
    /*0x296*/ { "CMSG_LFG_GET_STATUS",                                     STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleLfgGetStatus                       },
    ...
    /*0x2A3*/ { "CMSG_LOOT_MASTER_GIVE",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleLootMasterGiveOpcode               },
    ...
    /*0x2A8*/ { "CMSG_REPAIR_ITEM",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleRepairItemOpcode                   },
    /*0x2A9*/ { "SMSG_CHAT_PLAYER_NOT_FOUND",                              STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x2AA*/ { "MSG_TALENT_WIPE_CONFIRM",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleTalentWipeConfirmOpcode            },
    ...
    /*0x2B3*/ { "CMSG_SELF_RES",                                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSelfResOpcode                      },
    ...
    /*0x2C1*/ { "MSG_PETITION_RENAME",                                     STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetitionRenameOpcode               },
    ...
    /*0x2C4*/ { "CMSG_ITEM_NAME_QUERY",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleItemNameQueryOpcode                },
    ...
    /*0x2CE*/ { "CMSG_MOVE_TIME_SKIPPED",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleMoveTimeSkippedOpcode              },
    ...
    /*0x2D6*/ { "MSG_INSPECT_HONOR_STATS",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleInspectHonorStatsOpcode            },
    ...
    /*0x2EA*/ { "CMSG_PET_STOP_ATTACK",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetStopAttack                      },
    ...
    /*0x2F3*/ { "CMSG_PET_SPELL_AUTOCAST",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetSpellAutocastOpcode             },
    ...
    /*0x347*/ { "CMSG_SOCKET_GEMS",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSocketOpcode                       },
    ...
    /*0x34B*/ { "CMSG_ARENA_TEAM_QUERY",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleArenaTeamQueryOpcode               },
    /*0x34C*/ { "SMSG_ARENA_TEAM_QUERY_RESPONSE",                          STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x34D*/ { "CMSG_ARENA_TEAM_ROSTER",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleArenaTeamRosterOpcode              },
    ...
    /*0x35E*/ { "CMSG_SEARCH_LFG_JOIN",                                    STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleLfrSearchJoinOpcode                },
    /*0x35F*/ { "CMSG_SEARCH_LFG_LEAVE",                                   STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleLfrSearchLeaveOpcode               },
    ...
    /*0x374*/ { "CMSG_SET_TITLE",                                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSetTitleOpcode                     },
    /*0x375*/ { "CMSG_CANCEL_MOUNT_AURA",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCancelMountAuraOpcode              },
    /*0x376*/ { "SMSG_ARENA_ERROR",                                        STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x377*/ { "MSG_INSPECT_ARENA_TEAMS",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleInspectArenaTeamsOpcode            },
    /*0x378*/ { "SMSG_DEATH_RELEASE_LOC",                                  STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x379*/ { "CMSG_CANCEL_TEMP_ENCHANTMENT",                            STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleCancelTempEnchantmentOpcode        },
    ...
    /*0x3D2*/ { "CMSG_CHANNEL_DISPLAY_LIST",                               STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleChannelDisplayListQuery            },
    /*0x3D3*/ { "CMSG_SET_ACTIVE_VOICE_CHANNEL",                           STATUS_AUTHED,     PROCESS_THREADUNSAFE,   &WorldSession::HandleSetActiveVoiceChannel              },
    /*0x3D4*/ { "CMSG_GET_CHANNEL_MEMBER_COUNT",                           STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleGetChannelMemberCount              },
    /*0x3D5*/ { "SMSG_CHANNEL_MEMBER_COUNT",                               STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    /*0x3D6*/ { "CMSG_CHANNEL_VOICE_ON",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleChannelVoiceOnOpcode               },
    ...
    /*0x3F3*/ { "CMSG_CLEAR_CHANNEL_WATCH",                                STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleClearChannelWatch                  },
    ...
    /*0x3F8*/ { "CMSG_SPELLCLICK",                                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleSpellClick                         },
    ...
    /*0x414*/ { "CMSG_TOTEM_DESTROYED",                                    STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleTotemDestroyed                     },
    ...
    /*0x46B*/ { "CMSG_QUERY_INSPECT_ACHIEVEMENTS",                         STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQueryInspectAchievements           },
    ...
    /*0x477*/ { "CMSG_REQUEST_VEHICLE_PREV_SEAT",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleChangeSeatsOnControlledVehicle     },
    /*0x478*/ { "CMSG_REQUEST_VEHICLE_NEXT_SEAT",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleChangeSeatsOnControlledVehicle     },
    /*0x479*/ { "CMSG_REQUEST_VEHICLE_SWITCH_SEAT",                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleChangeSeatsOnControlledVehicle     },
    /*0x47A*/ { "CMSG_PET_LEARN_TALENT",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandlePetLearnTalent                     },
    ...
    /*0x481*/ { "CMSG_GAMEOBJ_REPORT_USE",                                 STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleGameobjectReportUse                },
    ...
    /*0x48A*/ { "CMSG_REMOVE_GLYPH",                                       STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleRemoveGlyph                        },
    ...
    /*0x49C*/ { "CMSG_HEARTH_AND_RESURRECT",                               STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleHearthAndResurrect                 },
    ...
    /*0x4B3*/ { "CMSG_ITEM_REFUND_INFO",                                   STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleItemRefundInfoRequest              },
    /*0x4B4*/ { "CMSG_ITEM_REFUND",                                        STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleItemRefund                         },
    ...
    /*0x4C1*/ { "CMSG_LEARN_PREVIEW_TALENTS",                              STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleLearnPreviewTalents                },
    /*0x4C2*/ { "CMSG_LEARN_PREVIEW_TALENTS_PET",                          STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleLearnPreviewTalentsPet             },
    ...
    /*0x4D5*/ { "CMSG_EQUIPMENT_SET_USE",                                  STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleEquipmentSetUse                    },
    ...
    /*0x4DF*/ { "CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE",              STATUS_LOGGEDIN,   PROCESS_THREADUNSAFE,   &WorldSession::HandleBfEntryInviteResponse              }, // pussywizard: unsafe, changes groups and much more >_>
    /*0x4E0*/ { "EFIELD_MGR_ENTERED",                                      STATUS_NEVER,      PROCESS_INPLACE,        &WorldSession::Handle_ServerSide                        },
    ...
    /*0x500*/ { "CMSG_QUERY_QUESTS_COMPLETED",                             STATUS_LOGGEDIN,   PROCESS_THREADSAFE,     &WorldSession::HandleQueryQuestsCompleted               },
